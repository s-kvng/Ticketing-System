...
create table "public"."tenants_permissions" (
    "id" bigint generated by default as identity not null,
    "created_at" timestamp with time zone not null default now(),
...
alter table "public"."tenants_permissions" enable row level security;
...
CREATE UNIQUE INDEX tenants_permissions_pkey ON public.tenants_permissions USING btree (id);
...
alter table "public"."tenants_permissions" add constraint "tenants_permissions_pkey" PRIMARY KEY using index "tenants_permissions_pkey";
...
alter table "public"."tenants_permissions" add constraint "tenants_permissions_service_user_fkey" FOREIGN KEY (service_user) REFERENCES service_users(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."tenants_permissions" validate constraint "tenants_permissions_service_user_fkey";

alter table "public"."tenants_permissions" add constraint "tenants_permissions_tenant_fkey" FOREIGN KEY (tenant) REFERENCES tenants(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."tenants_permissions" validate constraint "tenants_permissions_tenant_fkey";
...
grant delete on table "public"."tenants_permissions" to "anon";

grant insert on table "public"."tenants_permissions" to "anon";

grant references on table "public"."tenants_permissions" to "anon";

grant select on table "public"."tenants_permissions" to "anon";

grant trigger on table "public"."tenants_permissions" to "anon";

grant truncate on table "public"."tenants_permissions" to "anon";

grant update on table "public"."tenants_permissions" to "anon";

grant delete on table "public"."tenants_permissions" to "authenticated";

grant insert on table "public"."tenants_permissions" to "authenticated";

grant references on table "public"."tenants_permissions" to "authenticated";

grant select on table "public"."tenants_permissions" to "authenticated";

grant trigger on table "public"."tenants_permissions" to "authenticated";

grant truncate on table "public"."tenants_permissions" to "authenticated";

grant update on table "public"."tenants_permissions" to "authenticated";

grant delete on table "public"."tenants_permissions" to "service_role";

grant insert on table "public"."tenants_permissions" to "service_role";

grant references on table "public"."tenants_permissions" to "service_role";

grant select on table "public"."tenants_permissions" to "service_role";

grant trigger on table "public"."tenants_permissions" to "service_role";

grant truncate on table "public"."tenants_permissions" to "service_role";

grant update on table "public"."tenants_permissions" to "service_role";
